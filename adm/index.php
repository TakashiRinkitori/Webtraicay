	...
	<table border="0" cellpadding="0" cellspacing="0" width="960" align="center" style="margin-top:20px; margin-bottom:20px; background:#FFFFFF;">
		<tr>
			<td height="40" style="color:#FFFFCC; background:#66A111;" colspan="2" align="center">
				ADMIN CONTROL PANEL - Sieu Thi Trai Cay Online
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<div class="menuleft">
					<a href="#" onclick="adm_chuyentrang('quanlyloaiqua')">Quản Lý Loại Trái Cây</a>
					<a href="#" onclick="adm_chuyentrang('quanlyqua')">Quản Lý Trái Cây</a>
		...
		<tr>
			...
			Copyright © Nguyễn Hiếu Minh. Công Nghệ Thông Tin K70. 
			</td>
		</tr>
	</table>
